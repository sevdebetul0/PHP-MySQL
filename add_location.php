...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(empty($errors)) {
        ...
        if($location->create()) {
            ...
            $error_message = "Lokasyon kaydedilirken bir hata oluştu.";
        }
    } else {
...
<head>
    ...
    <title>Lokasyon Ekle - Dizi/Film Lokasyonları</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="add_location.php">
            ...
            <div class="col-lg-8">
                <div class="form-container">
                    <div class="form-header">
                        <h2><i class="fas fa-map-marker-alt me-2"></i>Yeni Lokasyon Ekle</h2>
                        <p class="mb-0 mt-2">Keşfettiğin yeni bir dizi/film lokasyonunu kaydet</p>
                    </div>
                    ...
                    <div class="form-body">
                        ...
                        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="locationForm">
                            <!-- Dizi/Film Bilgileri -->
                                    ...
                                    <select class="form-select" id="genre" name="genre" required>
                                        ...
                                        <?php foreach($genres as $genre): ?>
                                            <option value="<?php echo $genre; ?>" 
                                                    <?php echo (isset($_POST['genre']) && $_POST['genre'] == $genre) ? 'selected' : ''; ?>>
                                                <?php echo $genre; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="mb-3">
                                    <div class="form-floating">
                                        <textarea class="form-control" id="address" name="address" 
                                                  style="height: 80px" placeholder="Adres"><?php echo isset($_POST['address']) ? htmlspecialchars($_POST['address']) : ''; ?></textarea>
                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="4" 
                                              ...
                                              maxlength="500" onkeyup="updateCharCount('description', 500)"><?php echo isset($_POST['description']) ? htmlspecialchars($_POST['description']) : ''; ?></textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="scene_description" name="scene_description" rows="3" 
                                              ...
                                              maxlength="300" onkeyup="updateCharCount('scene_description', 300)"><?php echo isset($_POST['scene_description']) ? htmlspecialchars($_POST['scene_description']) : ''; ?></textarea>
                                    ...
                                    <div class="visited-toggle" id="visitedToggle">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="visited" name="visited" 
                                                   <?php echo (isset($_POST['visited'])) ? 'checked' : ''; ?>
                                                   onchange="toggleVisited()">
                                            <label class="form-check-label fw-semibold" for="visited">
                                                <span id="visitedText">
                                                    <?php echo (isset($_POST['visited'])) ? 'Bu lokasyonu ziyaret ettim ✅' : 'Henüz ziyaret etmedim ⏳'; ?>
                                                </span>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="d-flex gap-3 mt-4">
                                <button type="submit" class="btn btn-gradient flex-fill">
                                    <i class="fas fa-save me-2"></i>Lokasyonu Kaydet
                                </button>
